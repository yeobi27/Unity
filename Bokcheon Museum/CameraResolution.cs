...
public class CameraResolution : MonoBehaviour
{
    ...
    private void Start()
    {
        UIManager.Instance.transform.GetComponent<Canvas>().worldCamera = GameObject.FindWithTag("MainCamera").GetComponent<Camera>();
    ...
    public void Camera2View()
    {
        ...
        float scale_height = ((float)Screen.width / Screen.height) / ((float)16 / 9);    // 세로
        float scale_width = 1f / scale_height;   // 가로
