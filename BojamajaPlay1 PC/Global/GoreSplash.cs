...
public class GoreSplash : MonoBehaviour
{
    ...
    public void RandomForceAndTorque(Transform obj)
    {
        ...
        Vector3 randomBoundsPoint = new Vector3(Random.Range(col.bounds.center.x - col.bounds.extents.x, col.bounds.center.x + col.bounds.extents.x), transform.position.y, transform.position.z); //find random x and z coordinate on the collider
